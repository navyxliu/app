/*
 * Copyright (C) 2012 LiuXin (RetroGame)
...
public class GLRenderer implements Renderer {
    private static String TAG = "emul.gl";
    ...
    public void changedEmulatedSize() {
        Log.v(TAG,"changedEmulatedSize "+shortBuffer+" "+Emulator.getScreenBuffer());
        ...
        */
        ...
        if (Emulator.isDebug()) {
            ...
            if (System.currentTimeMillis() - millis >= 1000) {
                fps = i; i=0;millis = System.currentTimeMillis();
                Log.d(TAG, "Threaded fps:" + fps + " w:" + Emulator.getWindow_width()+" h:"+Emulator.getWindow_height());
            }             
        }
    }
}
